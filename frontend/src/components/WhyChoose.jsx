...
function WhyChoose() {
  return (
    <section className="w-full px-4 sm:px-6 lg:px-10 pt-8">
      <div className="w-full py-10 sm:py-12 lg:py-16 rounded-2xl">
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-4 sm:gap-6 lg:gap-8 px-4 sm:px-6 lg:px-8">
          {features.map((item, i) => (
            <div
              key={i}
            ...
            >
              ...
              <h3 className="relative text-sm sm:text-base font-semibold text-gray-900">
                {item.text}
              </h3>
